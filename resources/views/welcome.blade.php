        ...
        <div class="col-4">
            <div class="container w-100 mx-auto mt-4">
                <div class="row">
                    <div class="">
                        <div class="card" >
                            <div style="background-size:cover; background-position: center; background-repeat:no-repeat; background-image:url('images/{{ $item->img }}'); width:100%; height:250px;"></div>
                            <div class="card-body">
